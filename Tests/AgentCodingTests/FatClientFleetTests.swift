...
struct FatClientFleetTests {
    ...
    func aliasToRemote() {
        ...
        #expect(UtunForwarder.aliasToRemote("100.64.2.7", remoteCIDR: "192.168.64.0/24") == "192.168.64.7")
        // Literal route (remoteCIDR nil) → unchanged.
        #expect(UtunForwarder.aliasToRemote("192.168.64.7", remoteCIDR: nil as String?) == "192.168.64.7")
    }
