...
public final class LinuxImageManager {
    ...
    private static func setupScript(
        ...
        return [
            ...
            "chroot /mnt apk add chromium xorg-server xinit mesa-dri-gallium eudev dbus ttf-freefont ttf-dejavu font-noto-emoji font-liberation xf86-input-libinput agetty util-linux xterm openbox xrandr xdotool pulseaudio pulseaudio-alsa alsa-utils alsa-plugins-pulse || echo 'APK_ADD_CHROMIUM_FAILED'",
            ...
            "printf '%s\\n' 'strict_chain' 'proxy_dns' 'tcp_read_time_out 15000' 'tcp_connect_time_out 8000' '[ProxyList]' 'socks5 \t127.0.0.1 40000' > /mnt/etc/proxychains/proxychains.conf",
            "",
            ...
            "printf '%s\\n' 'permit nopass chrome as root cmd poweroff' 'permit nopass chrome as root cmd warp-cli' 'permit nopass chrome as root cmd bash' 'permit nopass chrome as root cmd sh' > /mnt/etc/doas.d/chrome.conf",
            "",
            "# Enable services",
