#!/usr/bin/python3 -u
"""Bromure phishing analysis agent — runs inside the guest VM.

Bridges Chrome native messaging (stdin/stdout) to the host over vsock.
The phishing-guard extension sends page analysis requests via native
messaging; this agent forwards them to the host PhishingAnalysisBridge
