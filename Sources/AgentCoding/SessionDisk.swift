...
public final class SessionDisk {
    ...
    /// and local-inference modes; the guest init copies it into place. The
    /// key is read from `OPENAI_API_KEY` (the env var SessionDisk exports for
    /// those cases). NOTE: the exact models.yml schema is validated live —
    /// this is the documented OpenAI-compatible shape.
    static func ompModelsYAML(base: String, model: String) -> String {
        """
        # Generated by Bromure AC; do not edit.
        providers:
          bromure:
