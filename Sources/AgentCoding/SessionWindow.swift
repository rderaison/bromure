...
// Docker/ports value types, AgentStatus and TabsModel moved to
// SessionModels.swift (platform-independent) so the iOS fat client can
// compile them without this AppKit window file.
...
// ProfileColor.hexInUI moved to SessionModels.swift (shared with iOS).
