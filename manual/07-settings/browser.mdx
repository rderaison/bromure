...
<p align="center">
  <img src="../images/editor-browser.en.jpg" width="600" alt="The Browser pane of the Edit workspace window, showing the Stay signed in to websites toggle (off); a Permissions section with Allow file uploads and Allow file downloads on and Allow camera and Allow microphone off; and a Browser image section marked Installed with a Re-download button" />
</p>
